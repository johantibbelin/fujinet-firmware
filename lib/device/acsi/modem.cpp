 ...
 */
void ACSIModem::telnet_event_handler(telnet_t *telnet, telnet_event_t *ev)
{
    switch (ev->type)
    {
    case TELNET_EV_DATA:
...
ACSIModem::ACSIModem(FileSystem *_fs, bool snifferEnable)
{
    activeFS = _fs;
...
void ACSIModem::at_connect_resultCode(int modemBaud)
{
    int resultCode = 0;
    switch (modemBaud)
    {
 ...
 */
void ACSIModem::at_cmd_resultCode(int resultCode)
{
    // H89_send_int(resultCode);
    // H89_send(ASCII_CR);
    // H89_send(ASCII_LF);
...
void ACSIModem::at_cmd_println(const char *s, bool addEol)
{
    // if (cmdOutput == false)
    //     return;
...
void ACSIModem::at_cmd_println(int i, bool addEol)
{
    // if (cmdOutput == false)
    //     return;
...
void ACSIModem::at_cmd_println(std::string s, bool addEol)
{
    // if (cmdOutput == false)
    //     return;
...
void ACSIModem::at_handle_wificonnect()
{
...
void ACSIModem::at_handle_wifilist()
{
    at_cmd_println();
...
void ACSIModem::at_handle_answer()
{
...
void ACSIModem::at_handle_pblist()
{
    at_cmd_println();
