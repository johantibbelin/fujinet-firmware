#ifndef ACSI_PRINTER_H
#define ACSI_PRINTER_H
...
class ACSIPrinter : public virtualDevice
{
protected:
    // SIO THINGS
...
public:
    ...
    ACSIPrinter(FileSystem *filesystem, printer_type printer_type = PRINTER_FILE_TRIM);
    ~ACSIPrinter();
