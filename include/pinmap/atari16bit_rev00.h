...
#ifdef PINMAP_ATARI16BIT_REV00

/* SD Card - fnFsSD.cpp */
#define PIN_CARD_DETECT (gpio_num_t)-1 // fnSystem.h
#define PIN_CARD_DETECT_FIX (gpio_num_t)-1 // fnSystem.h
...
#define PIN_DAC1 (gpio_num_t)-1 // not connected
